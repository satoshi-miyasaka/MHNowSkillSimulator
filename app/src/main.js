...
<section>
  ...
  <div>
  <br />
  物理攻撃力<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="a" /> = <br />
...
+ スタイル強化値<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="a2" value="0" />)
    × 攻撃力倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="a3" value="1" />
...
+ 錬成パラメータ<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="a5" value="0" />)
      × 攻撃活性<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="a6" value="1" />
<br />
  属性攻撃力<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b" /> = <br />
...
+ スタイル強化値<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b2" value="0" />)
      × 属性倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b3" value="1" />
  + 属性攻撃力UP<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b4" value="0" />)
  × 古龍属性倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b5" value="1" />
  × 弱点補正倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="b6" value="1" />
<br />
ダメージ<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c" /> = <br />
( 物理攻撃力(1) + 属性攻撃力(2) )
    × ダメージ倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c1" value="1" />
    × 武器固有補正<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c2" value="1" />
        × 会心倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c3" value="1" />
      × 武器SP倍率<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c4" value="1" />
    × 状態異常補正<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c5" value="1" />
            × 肉質<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c6" value="100" />/100
    × モーション値<input type="text" size="4" maxlength="4" inputmode="numeric" class="inputNumeric" id="c7" value="100" />/100
<br />
...
obj.forEach((inputNumeric) => {
  inputNumeric.addEventListener('input', () => {
    ...
    const a6 = Number(document.getElementById('a6').value);
    ...
    const c7 = Number(document.getElementById('c7').value);

    const cObj = document.getElementById('c');
    let c = (a + b) * c1 * c2 * c3 * c4 * c5 * (c6 / 100) * (c7 / 100);
    cObj.value = c;
  })
})
